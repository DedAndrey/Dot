...
FocusScope {
    ...
    function keyNavDown() {
        if (itemGrid.currentIndex < itemGrid.count-1) {
            gridView.currentIndex ++
            gridView.positionViewAtIndex(gridView.currentIndex, GridView.Contain);
            return true;
        } else {
    ...
    PC3.ScrollView {
        ...
        GridView {
            id: gridView
            property int iconSize: plasmoid.configuration.gridIconSize
                ...
                onWheel: {
                    if (rightTap){
                        if (wheel.angleDelta.y > 0)
                            plasmoid.configuration.gridIconSize=plasmoid.configuration.gridIconSize+16
                            else
                                plasmoid.configuration.gridIconSize=plasmoid.configuration.gridIconSize-16
                    }else  if(plasmoid.configuration.scrollableApps){
