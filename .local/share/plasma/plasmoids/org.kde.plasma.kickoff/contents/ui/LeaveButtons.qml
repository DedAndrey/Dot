...
Item {
    ...
    anchors.leftMargin:kickoffWidth-sidebarWidth<leaveButtonsRow.implicitWidth/2+kickoffWidth/2? sidebarWidth+ PlasmaCore.Units.gridUnit:(kickoffWidth-leaveButtonsRow.implicitWidth)/2
    RowLayout {
        id: leaveButtonsRow
        anchors {
