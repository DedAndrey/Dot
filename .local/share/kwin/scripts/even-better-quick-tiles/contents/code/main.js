...
var BQT = {
	...
	* 	@returns: QRect containing x,y, width and height fields
	...
	getMode : function() {
		...
		print("Screen bounds: "+screenBounds.x+"/"+screenBounds.y+"/"+screenBounds.height+"/"+screenBounds.width);

		if ((windowBounds.height >= screenBounds.height) && (windowBounds.width >= screenBounds.width)) {
			print("window is maximized")
			return MODES.CENTER_FULL;
		}
	...
	setMode : function(mode) {
		...
		client.frameGeometry = newFrameGeometry;
	},
