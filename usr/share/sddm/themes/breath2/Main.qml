            ...
            initialItem: Login {
                ...
                notificationMessage: {
                    ...
                    if (keystateSource.data["Caps Lock"]["Locked"]) {
                        ...
                        text += i18nd("plasma_lookandfeel_org.kde.lookandfeel","Включен Caps Lock")
...
//                         text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Suspend")
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Ждущий режим")
...
//                         text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Restart")
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Перезагрузить систему")
...
//                         text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Shutdown")
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Завершить работу")
...
//                         text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Different User")
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Переключить пользователя")
